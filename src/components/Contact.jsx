  ...
  return (
   ...
   <div class="py-4 bg-black text-white">
      ...
      <div class="flex flex-col w-full lg:w-2/5 p-8">
        <p class="text-3xl md:text-5xl text-yellow-500 my-4 leading-relaxed md:leading-snug">Contact me</p>
        ...
        <p class="font-sans text-sm md:text-lg my-2 md:my-4">Or find me on Instagram at @hiba_ri, I'll be happy to hear from you.</p>
      </div>
      <div class=" flex flex-col lg:w-3/5 justify-center w-full lg:-mt-12">
        <div class="container">
          <div class="relative flex justify-center min-w-0 break-words w-full">
